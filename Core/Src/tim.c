...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM1_MspInit 0 */
    ...
    PA9     ------> TIM1_CH2
    */
    GPIO_InitStruct.Pin = ECHO_1_Pin|ECHO_3_Pin;
  ...
  /* USER CODE END TIM2_MspInit 0 */
    ...
    PB11     ------> TIM2_CH4
    */
    GPIO_InitStruct.Pin = ECHO_4_Pin|ECHO_6_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    GPIO_InitStruct.Pin = ECHO_2_Pin|ECHO_5_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA9     ------> TIM1_CH2
    */
    HAL_GPIO_DeInit(GPIOA, ECHO_1_Pin|ECHO_3_Pin);
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PB11     ------> TIM2_CH4
    */
    HAL_GPIO_DeInit(GPIOA, ECHO_4_Pin|ECHO_6_Pin);

    HAL_GPIO_DeInit(GPIOB, ECHO_2_Pin|ECHO_5_Pin);
